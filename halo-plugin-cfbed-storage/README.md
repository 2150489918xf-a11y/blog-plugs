...
Halo attachment storage plugin for [MarSeventh/CloudFlare-ImgBed](https://github.com/MarSeventh/CloudFlare-ImgBed).

It uploads Halo attachments through the CloudFlare ImgBed upload API and can automatically create/sync the corresponding Halo storage policy.
